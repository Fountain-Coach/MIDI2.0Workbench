...
/// FlexDataMessages.SubdivisionClicks1FlexDataMessages0x6 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesSubdivisionClicks1FlexDataMessages0x6: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        (lo, hi) = setBits128(lo, hi, 6, offset: 24, width: 8)
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesSubdivisionClicks1FlexDataMessages0x6? {
        ...
        return FlexDataMessagesSubdivisionClicks1FlexDataMessages0x6(channel: channel, group: group, form: form)
    }
}
