...
/// MIDI20ChannelVoiceMessages.PitchBend (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesPitchBend: Equatable {
    public var group: UInt8
    public var channel: UInt8
    public var pitch: UInt32
    public init(group: UInt8, channel: UInt8, pitch: UInt32) {
    ...
    public func encode() -> UMP64 {
        ...
        raw = setBits(raw, value: UInt64(14), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesPitchBend? {
        if getBits(ump.raw, offset: 0, width: 4) != 4 { return nil }
        if getBits(ump.raw, offset: 8, width: 4) != 14 { return nil }
        ...
        return MIDI20ChannelVoiceMessagesPitchBend(group: group, channel: channel, pitch: pitch)
    }
}
