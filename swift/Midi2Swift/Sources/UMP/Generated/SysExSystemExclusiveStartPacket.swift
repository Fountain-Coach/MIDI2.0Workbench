...
/// SysEx.SystemExclusiveStartPacket (UMP64)
/// Source: libs/messageTypes.js:68
public struct SysExSystemExclusiveStartPacket: Equatable {
    ...
    public static func decode(_ ump: UMP64) -> SysExSystemExclusiveStartPacket? {
        ...
        return SysExSystemExclusiveStartPacket(group: group, bytecount: bytecount, byte1: byte1, byte2: byte2, byte3: byte3, byte4: byte4, byte5: byte5, byte6: byte6)
    }
}
