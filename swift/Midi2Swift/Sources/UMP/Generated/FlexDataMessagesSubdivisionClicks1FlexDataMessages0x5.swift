...
/// FlexDataMessages.SubdivisionClicks1FlexDataMessages0x5 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesSubdivisionClicks1FlexDataMessages0x5: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        (lo, hi) = setBits128(lo, hi, 0, offset: 16, width: 8)
        (lo, hi) = setBits128(lo, hi, 5, offset: 24, width: 8)
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesSubdivisionClicks1FlexDataMessages0x5? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 13 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 16, width: 8) != 0 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 24, width: 8) != 5 { return nil }
        ...
        return FlexDataMessagesSubdivisionClicks1FlexDataMessages0x5(channel: channel, group: group, form: form)
    }
}
