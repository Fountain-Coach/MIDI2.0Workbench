...
/// FlexDataMessages.SubdivisionClicks1 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesSubdivisionClicks1: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        (lo, hi) = setBits128(lo, hi, 2, offset: 16, width: 8)
        (lo, hi) = setBits128(lo, hi, UInt64(subdivisionclicks1), offset: 64, width: 8)
        (lo, hi) = setBits128(lo, hi, UInt64(subdivisionclicks2), offset: 72, width: 8)
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesSubdivisionClicks1? {
        ...
        return FlexDataMessagesSubdivisionClicks1(channel: channel, group: group, form: form, subdivisionclicks1: subdivisionclicks1, subdivisionclicks2: subdivisionclicks2)
    }
}
