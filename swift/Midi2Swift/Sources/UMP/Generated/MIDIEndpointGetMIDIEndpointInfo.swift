...
/// MIDIEndpoint.GetMIDIEndpointInfo (UMP128)
/// Source: libs/messageTypes.js:68
public struct MIDIEndpointGetMIDIEndpointInfo: Equatable {
    public var form: UInt8
    public var umpversionmajor: UInt8
    public var umpversionminor: UInt8
    public init(form: UInt8, umpversionmajor: UInt8, umpversionminor: UInt8) {
        precondition(form <= 3)
    ...
    public init(formEnum: Form, umpversionmajor: UInt8, umpversionminor: UInt8) {
        precondition(umpversionmajor <= 255)
        precondition(umpversionminor <= 255)
    ...
    public func encode() -> UMP128 {
        ...
        { let tmp = setBits128(lo, hi, 0, offset: 6, width: 10); lo = tmp.0; hi = tmp.1 }
    ...
    public static func decode(_ ump: UMP128) -> MIDIEndpointGetMIDIEndpointInfo? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 15 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 6, width: 10) != 0 { return nil }
        ...
        return MIDIEndpointGetMIDIEndpointInfo(form: form, umpversionmajor: umpversionmajor, umpversionminor: umpversionminor)
    }
}
