...
/// FlexDataMessages.FlexDataMessages0x1FlexDataMessages0x7 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x1FlexDataMessages0x7: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        { let tmp = setBits128(lo, hi, 7, offset: 24, width: 8); lo = tmp.0; hi = tmp.1 }
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x1FlexDataMessages0x7? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 13 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 16, width: 8) != 1 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 24, width: 8) != 7 { return nil }
        ...
        return FlexDataMessagesFlexDataMessages0x1FlexDataMessages0x7(channel: channel, group: group, form: form)
    }
}
