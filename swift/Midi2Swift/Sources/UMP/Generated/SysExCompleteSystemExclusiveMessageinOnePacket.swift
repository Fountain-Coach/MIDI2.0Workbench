...
/// SysEx.CompleteSystemExclusiveMessageinOnePacket (UMP64)
/// Source: libs/messageTypes.js:68
public struct SysExCompleteSystemExclusiveMessageinOnePacket: Equatable {
    ...
    public func encode() -> UMP64 {
        ...
        raw = setBits(raw, value: UInt64(0), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP64) -> SysExCompleteSystemExclusiveMessageinOnePacket? {
        if getBits(ump.raw, offset: 0, width: 4) != 3 { return nil }
        if getBits(ump.raw, offset: 8, width: 4) != 0 { return nil }
        ...
        return SysExCompleteSystemExclusiveMessageinOnePacket(group: group, bytecount: bytecount, byte1: byte1, byte2: byte2, byte3: byte3, byte4: byte4, byte5: byte5, byte6: byte6)
    }
}
