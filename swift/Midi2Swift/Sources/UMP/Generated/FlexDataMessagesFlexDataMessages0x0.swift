...
/// FlexDataMessages.FlexDataMessages0x0 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x0: Equatable {
    ...
    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x0? {
        ...
        return FlexDataMessagesFlexDataMessages0x0(channel: channel, group: group, form: form)
    }
}
