...
/// FlexDataMessages.FlexDataMessages0x2 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x2: Equatable {
    ...
    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x2? {
        ...
        return FlexDataMessagesFlexDataMessages0x2(channel: channel, group: group, form: form)
    }
}
