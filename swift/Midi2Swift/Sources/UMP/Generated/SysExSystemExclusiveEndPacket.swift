...
/// SysEx.SystemExclusiveEndPacket (UMP64)
/// Source: libs/messageTypes.js:68
public struct SysExSystemExclusiveEndPacket: Equatable {
    ...
    public static func decode(_ ump: UMP64) -> SysExSystemExclusiveEndPacket? {
        ...
        return SysExSystemExclusiveEndPacket(group: group, bytecount: bytecount, byte1: byte1, byte2: byte2, byte3: byte3, byte4: byte4, byte5: byte5, byte6: byte6)
    }
}
