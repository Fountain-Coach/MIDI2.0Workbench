...
/// UtilityMessages.JRClock (UMP32)
/// Source: libs/messageTypes.js:68
public struct UtilityMessagesJRClock: Equatable {
    ...
    public func encode() -> UMP32 {
        ...
        raw = setBits32(raw, value: UInt32(1), offset: 8, width: 4)
        return UMP32(raw: raw)
    }

    public static func decode(_ ump: UMP32) -> UtilityMessagesJRClock? {
        if getBits32(ump.raw, offset: 0, width: 4) != 0 { return nil }
        if getBits32(ump.raw, offset: 8, width: 4) != 1 { return nil }
        let group = UInt8(getBits32(ump.raw, offset: 4, width: 4))
        return UtilityMessagesJRClock(group: group)
    }
}
