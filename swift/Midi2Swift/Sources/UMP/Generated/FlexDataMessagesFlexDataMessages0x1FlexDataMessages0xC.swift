...
/// FlexDataMessages.FlexDataMessages0x1FlexDataMessages0xC (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x1FlexDataMessages0xC: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        { let tmp = setBits128(lo, hi, 12, offset: 24, width: 8); lo = tmp.0; hi = tmp.1 }
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x1FlexDataMessages0xC? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 13 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 16, width: 8) != 1 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 24, width: 8) != 12 { return nil }
        ...
        return FlexDataMessagesFlexDataMessages0x1FlexDataMessages0xC(channel: channel, group: group, form: form)
    }
}
