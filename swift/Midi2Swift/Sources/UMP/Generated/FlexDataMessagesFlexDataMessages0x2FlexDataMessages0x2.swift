...
/// FlexDataMessages.FlexDataMessages0x2FlexDataMessages0x2 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x2: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        (lo, hi) = setBits128(lo, hi, 2, offset: 24, width: 8)
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x2? {
        ...
        return FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x2(channel: channel, group: group, form: form)
    }
}
