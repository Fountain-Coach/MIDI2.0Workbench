...
/// MIDI20ChannelVoiceMessages.RegisteredPerNoteController (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesRegisteredPerNoteController: Equatable {
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesRegisteredPerNoteController? {
        ...
        return MIDI20ChannelVoiceMessagesRegisteredPerNoteController(group: group, channel: channel, notenumber: notenumber, index: index, value: value)
    }
}
