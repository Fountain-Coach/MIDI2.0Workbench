...
/// MIDI10ChannelVoiceMessages.NoteOn (UMP32)
/// Source: libs/messageTypes.js:68
public struct MIDI10ChannelVoiceMessagesNoteOn: Equatable {
    ...
    public func encode() -> UMP32 {
        ...
        raw = setBits32(raw, value: UInt32(9), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP32) -> MIDI10ChannelVoiceMessagesNoteOn? {
        if getBits32(ump.raw, offset: 0, width: 4) != 2 { return nil }
        if getBits32(ump.raw, offset: 8, width: 4) != 9 { return nil }
        ...
        return MIDI10ChannelVoiceMessagesNoteOn(group: group, channel: channel, notenumber: notenumber, velocity: velocity)
    }
}
