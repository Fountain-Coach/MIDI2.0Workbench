...
/// MIDI20ChannelVoiceMessages.RegisteredControllerRPN (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesRegisteredControllerRPN: Equatable {
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesRegisteredControllerRPN? {
        ...
        return MIDI20ChannelVoiceMessagesRegisteredControllerRPN(group: group, channel: channel, bank: bank, index: index, value: value)
    }
}
