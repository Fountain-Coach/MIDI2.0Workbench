...
/// UtilityMessages.NOOP (UMP32)
/// Source: libs/messageTypes.js:68
public struct UtilityMessagesNOOP: Equatable {
    ...
    public func encode() -> UMP32 {
        ...
        raw = setBits32(raw, value: UInt32(0), offset: 8, width: 4)
        return UMP32(raw: raw)
    }

    public static func decode(_ ump: UMP32) -> UtilityMessagesNOOP? {
        if getBits32(ump.raw, offset: 0, width: 4) != 0 { return nil }
        if getBits32(ump.raw, offset: 8, width: 4) != 0 { return nil }
        let group = UInt8(getBits32(ump.raw, offset: 4, width: 4))
        return UtilityMessagesNOOP(group: group)
    }
}
