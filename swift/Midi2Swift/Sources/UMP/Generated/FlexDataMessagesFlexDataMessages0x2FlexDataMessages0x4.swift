...
/// FlexDataMessages.FlexDataMessages0x2FlexDataMessages0x4 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x4: Equatable {
    ...
    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x4? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 13 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 16, width: 8) != 2 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 24, width: 8) != 4 { return nil }
        ...
        return FlexDataMessagesFlexDataMessages0x2FlexDataMessages0x4(channel: channel, group: group, form: form)
    }
}
