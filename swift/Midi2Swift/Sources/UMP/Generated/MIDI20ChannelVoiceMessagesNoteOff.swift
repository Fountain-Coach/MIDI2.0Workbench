...
/// MIDI20ChannelVoiceMessages.NoteOff (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesNoteOff: Equatable {
    ...
    public func encode() -> UMP64 {
        ...
        raw = setBits(raw, value: UInt64(8), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesNoteOff? {
        if getBits(ump.raw, offset: 0, width: 4) != 4 { return nil }
        if getBits(ump.raw, offset: 8, width: 4) != 8 { return nil }
        ...
        return MIDI20ChannelVoiceMessagesNoteOff(group: group, channel: channel, notenumber: notenumber, attributetype: attributetype, velocity: velocity, attribute: attribute)
    }
}
