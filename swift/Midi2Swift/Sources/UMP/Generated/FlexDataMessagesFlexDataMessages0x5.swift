...
/// FlexDataMessages.FlexDataMessages0x5 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x5: Equatable {
    ...
    public func encode() -> UMP128 {
        ...
        { let tmp = setBits128(lo, hi, 5, offset: 16, width: 8); lo = tmp.0; hi = tmp.1 }
        return UMP128(lo: lo, hi: hi)
    }

    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x5? {
        if getBits128(ump.lo, ump.hi, offset: 0, width: 4) != 13 { return nil }
        if getBits128(ump.lo, ump.hi, offset: 16, width: 8) != 5 { return nil }
        ...
        return FlexDataMessagesFlexDataMessages0x5(channel: channel, group: group, form: form)
    }
}
