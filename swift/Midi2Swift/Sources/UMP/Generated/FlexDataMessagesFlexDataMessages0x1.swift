...
/// FlexDataMessages.FlexDataMessages0x1 (UMP128)
/// Source: libs/messageTypes.js:68
public struct FlexDataMessagesFlexDataMessages0x1: Equatable {
    ...
    public static func decode(_ ump: UMP128) -> FlexDataMessagesFlexDataMessages0x1? {
        ...
        return FlexDataMessagesFlexDataMessages0x1(channel: channel, group: group, form: form)
    }
}
