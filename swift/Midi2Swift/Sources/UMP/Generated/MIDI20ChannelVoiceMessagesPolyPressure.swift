...
/// MIDI20ChannelVoiceMessages.PolyPressure (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesPolyPressure: Equatable {
    public var group: UInt8
    public var channel: UInt8
    public var notenumber: UInt8
    public var pressure: UInt32
    public init(group: UInt8, channel: UInt8, notenumber: UInt8, pressure: UInt32) {
    ...
    public func encode() -> UMP64 {
        ...
        raw = setBits(raw, value: UInt64(10), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesPolyPressure? {
        if getBits(ump.raw, offset: 0, width: 4) != 4 { return nil }
        if getBits(ump.raw, offset: 8, width: 4) != 10 { return nil }
        ...
        return MIDI20ChannelVoiceMessagesPolyPressure(group: group, channel: channel, notenumber: notenumber, pressure: pressure)
    }
}
