...
/// MIDI20ChannelVoiceMessages.AssignableControllerNRPNMessages (UMP64)
/// Source: libs/messageTypes.js:68
public struct MIDI20ChannelVoiceMessagesAssignableControllerNRPNMessages: Equatable {
    ...
    public func encode() -> UMP64 {
        ...
        raw = setBits(raw, value: UInt64(3), offset: 8, width: 4)
    ...
    public static func decode(_ ump: UMP64) -> MIDI20ChannelVoiceMessagesAssignableControllerNRPNMessages? {
        if getBits(ump.raw, offset: 0, width: 4) != 4 { return nil }
        if getBits(ump.raw, offset: 8, width: 4) != 3 { return nil }
        ...
        return MIDI20ChannelVoiceMessagesAssignableControllerNRPNMessages(group: group, channel: channel, bank: bank, index: index, value: value)
    }
}
